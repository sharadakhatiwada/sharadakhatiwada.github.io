...
// const annoTripple = imports.annoTripple;
// const arroFuncTripple = imports.arroFuncTripple;
...
describe("myMap", function () {
  ...
  it("tests myMap on triples anonymous function", function () {
    assert.deepStrictEqual(myMap(testArray, annoTripple), [-30, 0, 30, 60]);
  });
  it("tests myMap on triples arrow function", function () {
    assert.deepStrictEqual(myMap(testArray, arroFuncTripple), [-30, 0, 30, 60]);
  });
});
